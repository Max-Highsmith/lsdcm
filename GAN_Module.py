...
class GAN_Model(pl.LightningModule):
    def __init__(self):
        ...
        self.G_lr           = 1e-5
        self.D_lr           = 1e-5
        self.beta_1         = 0.9  #TODO
        self.beta_2         = 0.99
        self.num_res_blocks = 15
        self.generator      = hc.Generator(num_res_blocks=self.num_res_blocks)
        self.discriminator  = hc.Discriminator() 
        self.generator.init_params()
        self.discriminator.init_params()
        self.bce            = nn.BCEWithLogitsLoss()
        self.mse  = nn.L1Loss()
        self.vae_yaml       = "lightning_logs/version_4/hparams.yaml"
        self.vae_weight     = "lightning_logs/version_4/checkpoints/epoch=654.ckpt"
